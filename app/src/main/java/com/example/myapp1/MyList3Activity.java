...
public class MyList3Activity extends AppCompatActivity implements Runnable, AdapterView.OnItemClickListener {
...
//                    );
                    ...
                    //自定义适配器、自定义布局
                    MyAdapter adapter = new MyAdapter(MyList3Activity.this, R.layout.list_item, listItems);
